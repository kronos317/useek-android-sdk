...
public class CustomViewProgrammaticallyActivity extends AppCompatActivity implements USeekPlayerListener {
    ...
    LinearLayout    useakContainer;
    USeekPlayerView useakView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        useakContainer  = findViewById(R.id.useak_container);
        addUSeakPlayerView();
    ...
    private void addUSeakPlayerView() {
        useakView = new USeekPlayerView(this);
        useakContainer.addView(
                useakView.getView(),
